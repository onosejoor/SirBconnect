    ...
    <>
      <section id="scholarshipHeader">
        <HeaderCard
          ...
          src={
            dark === "false"
              ? "/images/Router/scholarships/scholarshipHeader.png"
              : "/images/Router/scholarships/scholarshipHeaderDark.png"
          }
      ...
      <section id="scholarshipAbout">
        ...
        <div className="design-container scholarshipAbout">
          <AboutText
            ...
            src="/images/Router/scholarships/scholarship.png"
      ...
      <section id="scholarshipServices">
        <h2 className="top point">Services We Render</h2>

        <div className="service-container">
          <ScholarshipServiceCard
            src="/images/Router/scholarships/moneyCap.jpg"
          ...
          <ScholarshipServiceCard
            src="/images/Router/scholarships/application.jpg"
          ...
          <ScholarshipServiceCard
            src="/images/Router/scholarships/search.jpeg"
